...
import { HElement, VerticalRoll, HorizontalRoll, VerticalFlowRoll, VerticalVisualRangeRoll, Position, HorizontalVisualRangeRoll, AutoFocus } from "./ui_tool/uiTool";
...
export {
    ...
    Position, Set, ManagementDynamicDB, AutoFocus
};